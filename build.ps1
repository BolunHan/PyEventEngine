...
Write-Host " PyEventEngine NT Build Script" -ForegroundColor Cyan
Write-Host "==============================================" -ForegroundColor Cyan
...
try {
    Remove-Item -Recurse -Force -ErrorAction SilentlyContinue build, "PyEventEngine.egg-info", "event_engine\includes"
...
try {
    ...
    Write-Host "[build] Complete — event_engine compiled in-place" -ForegroundColor Green
}
finally {
    Pop-Location
}
